...
const PublicCards = ({ item }) => {
  return (
    <div className="h-[354px] w-64 p-4 space-y-2 text-white bg-green-600 rounded-xl bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 border border-gray-100">
